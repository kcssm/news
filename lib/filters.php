 ...
 */
function _gpp_browser_class( $classes ) {
...
add_filter( 'body_class', '_gpp_browser_class' );
 ...
 * @since _gpp 1.0
 */
function _gpp_page_menu_args( $args ) {
	$args[ 'show_home' ] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', '_gpp_page_menu_args' );
 ...
 * @since _gpp 1.0
 */
function _gpp_enhanced_image_navigation( $url, $id ) {
...
add_filter( 'attachment_link', '_gpp_enhanced_image_navigation', 10, 2 );